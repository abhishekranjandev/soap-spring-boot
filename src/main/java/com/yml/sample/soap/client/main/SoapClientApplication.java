package com.yml.sample.soap.client.main;
...
import com.yml.sample.soap.server.service.ObjectFactory;


@SpringBootApplication
@ComponentScan("com.yml.sample.soap.client.config")
public class SoapClientApplication implements CommandLineRunner {
	...
	private Object getHeader(final String userId, final String password) {
		final https.localhost._8080.sample.ObjectFactory headerObjectFactory = new https.localhost._8080.sample.ObjectFactory();

 ...
 * 
 */
@WebServiceClient(name = "HelloWorldServiceImplService", targetNamespace = "http://impl.server.soap.sample.yml.com/", wsdlLocation = "http://localhost:9999/service/hello-world?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICEIMPLSERVICE_QNAME = new QName("http://impl.server.soap.sample.yml.com/", "HelloWorldServiceImplService");
    ...
    public HelloWorldService getHelloWorldServiceImplPort() {
        return super.getPort(new QName("http://impl.server.soap.sample.yml.com/", "HelloWorldServiceImplPort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.server.soap.sample.yml.com/", "HelloWorldServiceImplPort"), HelloWorldService.class, features);
    }

 ...
 * generated in the com.yml.sample.soap.server.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://service.server.soap.sample.yml.com/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://service.server.soap.sample.yml.com/", "helloWorld");
    private final static QName _Arg1_QNAME = new QName("http://service.server.soap.sample.yml.com/", "arg1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.yml.sample.soap.server.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.soap.sample.yml.com/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.soap.sample.yml.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.soap.sample.yml.com/", name = "arg1")
